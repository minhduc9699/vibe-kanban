...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::scheduled_task::ScheduledTask::decl(),
        db::models::scheduled_task::ScheduledTaskStatus::decl(),
        db::models::scheduled_task::CreateScheduledTask::decl(),
        db::models::notification::Notification::decl(),
        db::models::notification::NotificationType::decl(),
        ...
        server::routes::plans::PlanPhaseProgress::decl(),
        server::routes::plans::PlanPhaseDetail::decl(),
        server::routes::plans::PlanMetadata::decl(),
        server::routes::plans::PlanPhaseSelection::decl(),
        server::routes::plans::ImportPlansRequest::decl(),
        server::routes::plans::ImportPlansResponse::decl(),
        server::routes::plans::PlanFileContent::decl(),
        ...
        executors::executors::ccs::Ccs::decl(),
...
fn generate_schemas() -> Result<HashMap<&'static str, String>, serde_json::Error> {
    ...
    let schemas: HashMap<&str, String> = HashMap::from([
        ...
        (
            "ccs",
            generate_json_schema::<executors::executors::ccs::Ccs>()?,
        ),
    ]);
    println!(
